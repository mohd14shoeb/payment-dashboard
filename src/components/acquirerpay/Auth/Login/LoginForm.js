            ...
            <Form method={'post'}>
                ...
                <InputGroup className="mb-4">
                    ...
                    <Input type="password" placeholder="Password" autoComplete="current-password" name="password"
                        value={password} onChange={this.props.onChange}/>
                </InputGroup>
                {errors.password && <Alert color="warning">{errors.password}</Alert>}

                <Row>
                    <Col xs="6">
                        <Button color="primary" type="submit" onClick={this.props.onClick} className="px-4">Login</Button>
                    </Col>
