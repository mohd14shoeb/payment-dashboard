          ...
          <Row className="justify-content-center">
            <Col md="8">
              <CardGroup>
                <Card className="p-4">
                  <CardBody>
                    <LoginForm onClick={this.handleSubmit.bind()} onChange={this.handleChange} email={email} password={password} errors={errors}/>
                  </CardBody>
                </Card>
                <Card className="text-white bg-primary py-5 d-md-down-none" style={{width: '44%'}}>
                  <CardBody className="text-center">
                    <div>
                      <h2>Sign up</h2>
                      <p>Lorempp ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut
